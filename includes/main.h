...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/06 18:06:54 by lnorcros          #+#    #+#             */
/*   Updated: 2021/04/06 18:06:56 by lnorcros         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ARGS_ERROR "Arguments error"
# define NO_CONFIG_ERROR "No configuration file"
# define CONFIG_FORMAT_ERROR "Wrong map file format"
...
void			sort_sprites(int *sprite_ord, double *sprite_dist, int len);
